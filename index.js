...
if (process.platform === 'win32') {
  ...
  destRoot = 'C:\\Users\\Max Baun\\Desktop\\Backup\\' + destFolder;
} else {
  crateStr = `/Volumes/Music/_Serato_/Subcrates/${crateName}.crate`;
  crateFile = fs.readFileSync(crateStr);
  const crateParts = crateStr.split('/');
  const destFolder = crateParts[crateParts.length - 1].split('.crate')[0];
  destRoot = '/Users/maxbaun/Desktop/Backup/' + destFolder;
}
